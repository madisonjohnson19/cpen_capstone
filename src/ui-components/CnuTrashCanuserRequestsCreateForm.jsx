...
export default function CnuTrashCanuserRequestsCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
    ...
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await DataStore.save(new CnuTrashCanuserRequests(modelFields));
          if (onSuccess) {
      ...
      {...getOverrideProps(overrides, "CnuTrashCanuserRequestsCreateForm")}
      {...rest}
    >
      <TextField
        label="Pk"
